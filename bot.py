...
async def cmd_start(client, message: Message):
    ...
    if message.from_user.id == OWNER_ID:
        await message.reply_text(
            ...
            "<b>Broadcast</b>\n"
            "/broadcast &lt;text&gt; — Message everyone who has ever started this bot\n\n"
...
async def admin_broadcast(client, message: Message):
    ...
    for u in all_users:
        try:
            await client.send_message(u["_id"], text, protect_content=True)
            sent += 1
...
async def cmd_help(client, message: Message):
    await message.reply_text(
        ...
        "<b>Broadcast</b>\n"
        "/broadcast &lt;text&gt; sends a message to everyone who has ever "
        "sent /start to this bot (a separate list from store Visitors, "
        "since it doesn't require opening the Mini App).\n\n"
